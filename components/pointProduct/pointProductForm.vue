                    ...
                    <div class="uk-accordion-content">
                        <form class="uk-grid-small uk-grid" data-uk-grid>
                            <div class="uk-width-1-2 uk-margin-small-bottom">
                                <div class="uk-margin uk-heading-hero" style="text-align: left; margin-left:5px; margin-bottom: 0px; color:rgba(0, 0, 0, 0.54);font-size: 0.75rem;"><span>상품구분</span></div>
                                <Select2 div-style="padding:0" v-model="sendData.productType" :options="productTypeOpts" :settings="{ 'width': '100%', 'placeholder': '상품구분' }"/>
                            </div>
                            <div class="uk-width-1-4">
                                <div class="uk-margin uk-heading-hero" style="text-align: left; margin-left:5px; margin-bottom: 0px; color:rgba(0, 0, 0, 0.54);font-size: 0.75rem;"><span>상품노출</span></div>
                            ...
                            <div class="uk-width-1-4">
                                <div class="uk-margin uk-heading-hero" style="text-align: left; margin-left:5px; margin-bottom: 0px; color:rgba(0, 0, 0, 0.54);font-size: 0.75rem;"><span>매진여부</span></div>
                            ...
                            <div class="uk-width-1-1 uk-margin-small-bottom">
                                <ScInput v-model="sendData.category" :error-state="$v.sendData.category.$error"
                                         :validator="$v.sendData.category">
                                    <label>
                                        카테고리
                                    </label>
                                ...
                                <ul class="sc-vue-errors">
                                    <li v-if="!$v.sendData.category.required">
                                        카테고리를 입력하세요.
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="uk-width-1-2 uk-margin-small-bottom">
                                <div class="uk-margin uk-heading-hero" style="text-align: left; margin-left:5px; margin-bottom: 10px; color:rgba(0, 0, 0, 0.54);font-size: 0.75rem;"><span>리스트이미지</span></div>
                                <div data-uk-form-custom="target: true">
                                    ...
                                    <div class="uk-width-1-1 image-preview" v-if="listImageData">
                                        <img class="preview" :src="listImageData">
                                    </div>
                                </div>
                            </div>
                            <div class="uk-width-1-2 uk-margin-small-bottom">
                                ...
                                <div data-uk-form-custom="target: true">
                                    ...
                                    <div class="uk-width-1-1 image-preview" v-if="detailImageData">
                                        <img class="preview" :src="detailImageData">
                                    </div>
                                </div>
                            </div>
                        </form>
