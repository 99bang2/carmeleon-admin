                            ...
                            <tr>
                                <td>
                                    <div class="uk-display-inline-block">
                                        <img
                                                :src="sendData.profileImage"
                                                class="sc-avatar sc-avatar-initials-lg"
                                        >
                                    </div>
                                </td>
                                <td><span class="uk-text-bold">닉네임</span> {{sendData.nickname}}</td>
                            </tr>
                            <tr>
                                <td><span class="uk-text-bold">이메일</span> {{sendData.email}}</td>
                                <td><span class="uk-text-bold">폰번호</span> {{sendData.phone}}</td>
                            </tr>
                            <tr>
                            </tr>
                            <tr>
                                <td><span class="uk-text-bold">푸시알림 동의</span> {{sendData.push}}</td>
                                <td><span class="uk-text-bold">포인트</span> {{sendData.point}}</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <span class="uk-text-bold">마케팅 수신동의</span> {{sendData.marketing}}
                                </td>
                            </tr>
                            <tr>
